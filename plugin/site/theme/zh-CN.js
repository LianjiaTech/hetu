module.exports = {
  messages: {
    ...
    'app.home.product-mobile-slogan': 'antd-mobile 是 antd 移动规范的实现',
    'app.home.product-antv-slogan': '简单、专业、拥有无限可能的数据可视化解决方案',
    'app.home.product-landing-slogan': '基于 antd 设计语言的 Landing 模板与规范',
    'app.home.tool-title': '工具和资源',
    'app.home.tool-package-title': 'antd 资源包',
    'app.home.tool-package-content': 'antd 相关设计资源下载',
    ...
    'app.home.more': '查看更多',
    'app.home.more-mobile-react': 'antd Mobile of React',
    'app.home.more-mobile-angular': 'antd Mobile of Angular',
    'app.footer.repo': 'GitHub 仓库',
    'app.footer.awesome': 'Awesome antd',
    'app.footer.course': 'antd 实战教程',
