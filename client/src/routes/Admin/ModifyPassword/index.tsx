...
class RegisterForm extends React.Component<IProps, IState> {
  ...
  asyncSendData = async (data: any) => {
    const res = await Api.Admin.asyncModifyPassword({ ...data, password: md5(data.password) })
        ...
        <LoginLayout>
          <Form {...formItemLayout} onSubmit={this.handleSubmit}>
            ...
            <FormItem style={{ marginTop: '10px' }}>
              <Button loading={is_submit_btn_loading} block size="large" type="primary" onClick={this.handleSubmit}>重 置 密 码</Button>
