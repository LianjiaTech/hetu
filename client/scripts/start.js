...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then((port) => {
    ...
    const urls = prepareUrls(protocol, '127.0.0.1', port)
    const devSocket = {
    ...
    devServer.listen(port, HOST, (err) => {
      ...
      if (isWsl) {
        ...
        console.log(`WSL can not use open browser in this version`)
        console.log(`Click ${urls.localUrlForBrowser} by yourself`)
        console.log(``)
      } else {
